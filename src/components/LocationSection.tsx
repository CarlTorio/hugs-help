...
import { getSiteInfo, type SiteInfo } from "@/components/admin/AdminContactInfo";
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          >
            ...
            <a
              ...
              style={{ background: "transparent", color: "#FFFFFF", border: "1.5px solid #8B0000" }}
